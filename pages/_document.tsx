...
export default function Document() {
  return (
    <Html lang="en">
      ...
      <meta property="og:image" content="http://deq-labs-social-1.s3.amazonaws.com/Deq+Twitter+Cover.png"></meta>
      ...
      <meta name="twitter:image" content="http://deq-labs-social-1.s3.amazonaws.com/Deq+Twitter+Cover.png"></meta>
      </Head>
      <body>
        <Main />
        <NextScript />
